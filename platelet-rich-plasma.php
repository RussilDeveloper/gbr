      ...
      <?php include 'header.php'; ?>
         ...
         <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row hd">
               <div class="col-md-12">
                <h1 class="hed">Platelet Rich Plasma</h1>
               </div>
             </div>
            </div>
         </section>
        ...
        <section class="sec1">
          <div class="container">
             <div class="row" style="padding-top: 50px; padding-bottom: 50px;">
                ...
                <div class="col-md-10">
                  <iframe class="vd" width="100%" height="450" src="https://www.youtube.com/embed/Pq7TYybP23w" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
               </div>
               <div class="col-md-1"></div>
            ...
            <div class="row" style="display: flex;">
               ...
               <div class="col-md-8">
                   ...
                   <h3 class="fs">Use of PRP</h3>
                   
                  <ul class="wh">                    
                    <li> Used in IUI and IVF to assist with and improve egg quantity and quality.</li>
                    <li> Used to improve uterine lining thickness or enhance endometrial receptivity during an embryo transfer.</li>
                    <li> It has the potential to address some of the most common barriers to a successful pregnancy.</li>                                                        
                  </ul>                     
               </div>
