      ...
      <?php include 'header.php'; ?>
         ...
         <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row">
               <div class="col-md-12">
                <h1 class="hed">Endometrial Receptivity Array</h1>
               </div>
             </div>
            </div>
         </section>
...
<!--section open--->
          ...
          <div class="container">
            <div class="row" style="padding: 70px">
                ...
                <div class="col-md-10">
                  <iframe class="vd" width="100%" height="450" src="https://www.youtube.com/embed/_jUWydoKfuQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
               </div>
               <div class="col-md-1"></div>
            ...
            <div class="row" style="display: flex;">
               ...
               <div class="col-md-8">
                 <p class="txt1">The Endometrial Receptivity Array (ERA) is a procedure that is used to diagnose if the endometrial cavity is ready for embryo implantation.</p>
                 ...
                 <ul class="wh">
                   ...
                   <h3 class="fs">There are three potential results</h3>                   
                  <ul class="wh">                    
                    <li><b> Pre-receptive:</b> The lining is not yet ready to receive an embryo, and implantation is less likely to occur.</li>
                    <li><b> Receptive:</b> The lining is ready to receive the embryo, which is most likely to implant.</li>
                    <li><b> Post-receptive:</b> The lining has already reached the stage for optimal embryo implantation but is no longer in that stage. The embryo is less likely to implant at this time.</li>
