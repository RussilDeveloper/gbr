...
<!--section open--->
          ...
          <div class="container">
            <div class="row" style="padding-top: 50px; padding-bottom: 50px;">
                ...
                <div class="col-md-10">
                  <iframe class="vd" width="100%" height="450" src="https://www.youtube.com/embed/SoprBHHsEXM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
               </div>
               <div class="col-md-1"></div>
            ...
            <div class="row" style="display: flex;">
               ...
               <div class="col-md-8">
                 <p class="txt1">Myomectomy is executed for the affected person affected by uterine fibroids, normally for the non-cancerous ones. The suggested waiting time after surgery before attempting conception is about three to six months. This time period allows the uterus the required time to heal.</p>
                 ...
                 <ul class="wh">
                   ...
                   <h3 class="fs">Benefits of Myomectomy</h3>  
                  <ul class="wh">                
                    <li> Myomectomy provides good scope for fertility improvement.</li>
                    <li> Gives good pregnancy outcomes within about a year of surgery.</li>
