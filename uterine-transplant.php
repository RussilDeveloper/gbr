      ...
      <?php include 'header.php'; ?>
         ...
         <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row hd">
               <div class="col-md-12">
                <h1 class="hed">Uterine Transplant</h1>
               </div>
             </div>
            </div>
         </section>
...
<!--section open--->
          ...
          <div class="container">
            <div class="row" style="padding-top: 50px; padding-bottom: 50px;">
                ...
                <div class="col-md-10">
                   <iframe class="vd" width="100%" height="450" src="https://www.youtube.com/embed/_bkV6Qyim7c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
               <div class="col-md-1"></div>
            ...
            <div class="row" style="display: flex;">
               ...
               <div class="col-md-8">
                 <p class="txt1">A uterus transplant is a promising new procedure that is helping some women overcome uterine factor infertility (UFI) and have a baby.</p>
                 ...
                 <h3 class="fs">Benefits of Uterus Transplant:</h3>                                     
                  <ul class="wh">                    
                    <li> It is a boon for many women who would prefer this method to the others, and the current status of uterine transplants promises an exciting future for women with AUFI.</li>
                  </ul>   

                 <h3 class="fs">Risks involved?</h3> 
                   <ul class="wh">                    
                    <li> Massive blood loss requiring transfusion as a life-saving effort.</li>
                    <li> Infection.</li>
                    <li> Organ rejection.</li>
                    <li> Potential for adverse reaction to immunosuppressive or anti-rejection medications.
                    </li>
                  </ul>  
               </div>  
