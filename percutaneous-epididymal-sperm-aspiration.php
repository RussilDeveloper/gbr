      ...
      <?php include 'header.php'; ?>
         ...
         <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row">
               <div class="col-md-12">
                <h1 class="hed">Percutaneous Epididymal Sperm Aspiration</h1>
               </div>
             </div>
            </div>
         </section>
        ...
        <section class="sec1">
          <div class="container">
            <div class="row" style="padding: 70px">
                ...
                <div class="col-md-10">
                  <iframe class="vd" width="100%" height="450" src="https://www.youtube.com/embed/8OPEx-htRiQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
               </div>
               <div class="col-md-1"></div>
            ...
            <div class="row" style="display: flex;">
               ...
               <div class="col-md-8">
                  <p class="txt1">Percutaneous epididymal sperm aspiration (PESA) is a technique used to determine sperm count in cases of possible obstruction of the vas deferens.</p>      
                  
                
                   <h3 class="fs">Benefits of PESA</h3>
                   
                  <ul class="wh">                    
                    <li> Involves no complex surgical process.</li>
                    <li> Minimum pain & discomfort.</li>
                    <li> Risks of complications are very limited.</li> 
                    <li> No open surgery and is not time consuming.</li> 
                    <li> Can be repeated 2-4 times to get an adequate number of sperms.</li>                                    
                 </ul>                     
               </div>
