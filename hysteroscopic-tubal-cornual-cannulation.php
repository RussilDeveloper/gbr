      ...
      <?php include 'header.php'; ?>
          ...
          <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row">
               <div class="col-md-12">
                <h1 class="hed">Hysteroscopic Tubal Cornual Cannulation</h1>
               </div>
             </div>
            </div>
         </section>
        ...
        <section class="sec1">
          <div class="container">
            ...
            <div class="row" style="display: flex;">
               <div class="col-md-8">
                 <p class="txt1">Tubal cannulation is a procedure to open corneal blockages (origin of the fallopian tubes near the uterus).</p>
                        
               
                                                         
                   <h3 class="fs">Risk Factors:</h3>
                   
                  <ul class="wh">                    
                    <li> Failure in making the fallopian tube functional.</li>
                    <li> Pinhole tubal perforation, tubal dissection, or tear in the fallopian tube wall.</li>
                    <li> Peritonitis, a life-threatening infection of the tissue covering organs in the belly.</li>                          
                  </ul>                     
               </div>
