      ...
      <?php include 'header.php'; ?>
          ...
          <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row hd">
               <div class="col-md-12">
                <h1 class="hed">Robotic Surgery</h1>
               </div>
             </div>
            </div>
         </section>
        ...
        <section class="sec1">
          <div class="container">
             <div class="row" style="padding-top: 50px; padding-bottom: 50px;">
                ...
                <div class="col-md-10">
                  <iframe class="vd" width="100%" height="450" src="https://www.youtube.com/embed/5KkoH-lvnZY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
               </div>
               <div class="col-md-1"></div>
            ...
            <div class="row" style="display: flex;">
               <div class="col-md-8">
                 <p class="txt1">Robotic surgery, or robot-assisted surgery, allows doctors to perform many  types of complex procedures with more precision, flexibility, and control than is possible with conventional techniques.</p>
                        
               
                                                         
                   <h3 class="fs">Benefits of Robotic Surgery:</h3>
                   
                  <ul class="wh">                    
                    <li> Less postoperative pain, scarring and blood loss.</li>
                    <li> Faster recovery time and shorter hospital stay.</li>
                    <li> Reduced chance of post-surgical complications, including infections.</li>
                    <li> Better cosmetic results with less scarring due to smaller incisions.</li>       
                  </ul>                     
               </div>
