      ...
      <?php include 'header.php'; ?>
         ...
         <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row">
               <div class="col-md-12">
                <h1 class="hed">Preimplantation Genetic Diagnosis and Screening</h1>
               </div>
             </div>
            </div>
         </section>
...
<!--section open--->
          ...
          <div class="container">
            <div class="row" style="padding: 70px">
                ...
                <div class="col-md-10">
                 <iframe class="vd" width="100%" height="450" src="https://www.youtube.com/embed/uheUy47yADU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
               </div>
               <div class="col-md-1"></div>
            ...
            <div class="row" style="display: flex;">
               ...
               <div class="col-md-8">
                 <p class="txt1">Preimplantation genetic checking out is a way used to discover genetic defects in embryos created thru in vitro fertilization (IVF) earlier than being pregnant. Whereas Preimplantation genetic screening (PGS), also known as preimplantation genetic testing for aneuploidy (PGT-A), determines the chromosomal status of an embryo by screening all 23 chromosome pairs, and tests for chromosomal abnormalities.</p>
                 ...
                 <ul class="wh">
                   ...
                   <h3 class="fs">Benefits of PGD</h3>                   
                  <ul class="wh">                    
                    <li> The ability to diagnose and exclude embryos with verified genetic abnormalities prior to implantation.</li>
                    <li> PGD offers an alternative for couples with single-cell gene defects who would otherwise depend on prenatal diagnosis to determine the genetic status of their pregnancy.</li>
                    <li> Couples have been able to avoid clinical pregnancy termination later on.</li>
