          ...
          <div class="container">
           <div class="row" style="padding-top: 50px; padding-bottom: 50px;">
            ...
            <div class="row" style="display: flex;">
               <div class="col-md-8">
                 <p class="txt1">Vaginoplasty is a surgical procedure that creates or reshapes the vaginal opening. It is used to treat ambiguous genitalia caused by intersex conditions, congenital vaginal or cloacal anomalies, and severe vaginal trauma.</p>
                        
               
                                                         
                   <h3 class="fs">What are the risks involved?</h3>
                   
                  <ul class="wh">                    
                    <li> Painful intercourse.</li>
                    <li> Numbness or loss of sensation.</li>
                    <li> Infection in the operated parts.</li>
                    <li> Permanent changes in sensation.</li>  
                    <li> Ongoing pain and Scarring.</li>                            
                  </ul>                     
               </div>
