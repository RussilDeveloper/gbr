      ...
      <?php include 'header.php'; ?>
         ...
         <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row">
               <div class="col-md-12">
                <h1 class="hed">Genetics and Stem Cell Therapy</h1>
               </div>
             </div>
            </div>
         </section>
...
<!--section open--->
          ...
          <div class="container">
            <div class="row" style="padding: 70px">
                ...
                <div class="col-md-10">
                   <iframe class="vd" width="100%" height="450" src="https://www.youtube.com/embed/wbHxrOp0-WM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
               <div class="col-md-1"></div>
            ...
            <div class="row" style="display: flex;">
               ...
               <div class="col-md-8">
                 <p class="txt1">Stem Cell Therapy is a popular method in which stem cells will be collected at the time of birth.</p>
                 ...
                 <h3 class="fs">Stem Cell Treatment for Male Infertility</h3>
                 <p class="txt1">In essence, the stem cell treatment for male infertility is done through the procedure of spermatogenesis. The process helps haploid spermatozoa in developing from germ cells in the testis tubules.</p>                                     
                 

                 <h3 class="fs">Stem Cell Treatment for Female Infertility</h3> 
                 <p class="txt1">Stem cell therapy can be beneficial for women with infertility as well. It can help in oocyte generation and ovarian cell production. This way, their overall fertility level can increase massively. Furthermore, it can also repair the tissues of the uterus. This helps women get rid of their infertile state and go on towards motherhood.</p>   
