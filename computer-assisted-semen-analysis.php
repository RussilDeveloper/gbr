      ...
      <?php include 'header.php'; ?>
          ...
          <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row">
               <div class="col-md-12">
                <h1 class="hed">Computer Assisted Semen Analysis</h1>
               </div>
             </div>
            </div>
         </section>
        ...
        <section class="sec1">
          <div class="container">
            ...
            <div class="row" style="display: flex;">
               ...
               <div class="col-md-8">
                <p class="txt1">Computer-aided sperm analysis (CASA) technology is a technology developed for analysing sperm movement characteristics or kinematics.</p>
                                                         
                   <h3 class="fs">Advantages of CASA</h3>
                   
                  <ul class="wh">                    
                    <li> CASA provides fast, accurate and objectively repeatable results.</li>
                    <li> It can also perform certain specialised tests for parameters such as sperm vitality & sperm DNA fragmentation index, all of which help to identify the reasons for fertility.
                    </li>
