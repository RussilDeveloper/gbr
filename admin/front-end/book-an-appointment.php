...
<link href="https://fonts.googleapis.com/css2?family=Roboto&display=swap" rel="stylesheet">
  ...
  <div class="login-root" style="background-color:transparent;border-radius:10px">
                  ...
                  <div class="row">
                      <div class="col-md-6">
                        <div class="field padding-bottom--24">
                          ...
                          <input type="text" id="name" style="color:#000;" name="name"  required autocomplete="off">
                      ...
                      <div class="col-md-6">
                          ...
                          <input type="email" id="email" style="color:#000;" name="email"  required autocomplete="off">
                        </div>
                      </div>  
                      ...
                      <div class="col-md-6">
                           <div class="field padding-bottom--24">
                              ...
                              <input id="phone" type="number" style="color:#000;" name="phone" required autocomplete="off">
                            </div>
                      </div> 
                      <div class="col-md-6">
                           <div class="field padding-bottom--24">
