      ...
      <?php include 'header.php'; ?>
          ...
          <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row hd">
               <div class="col-md-12">
                <h1 class="hed">Tubal Ligation Reversal</h1>
               </div>
             </div>
            </div>
         </section>
        ...
        <section class="sec1">
          <div class="container">
            ...
            <div class="row" style="display: flex;">
               <div class="col-md-8">
                 <p class="txt1">Tubal ligation reversal may be a method to reestablish ripeness in ladies who have had tubal ligation - a method that cuts or pieces the fallopian tubes to avoid pregnancy.</p>
                        
               
                                                         
                   <h3 class="fs">Benefits of Tubal Ligation Reversal:</h3>
                   
                  <ul class="wh">                    
                    <li> Roughly, 50-80% of women who have TLR go on to have a successful pregnancy.</li>
                    <li> Is done mostly through minimally invasive laparoscopy these days.</li>
                    <li> The surgery usually takes only about 2 to 3 hours.</li>                          
                  </ul>                     
               </div>
