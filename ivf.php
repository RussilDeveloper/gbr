      ...
      <?php include 'header.php'; ?>
         ...
         <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row hd">
               <div class="col-md-12">
                <h1 class="hed">In Vitro Fertilisation</h1>
               </div>
             </div>
            </div>
         </section>
...
<!--section open--->
          ...
          <div class="container">
             <div class="row" style="padding-top: 50px; padding-bottom: 50px;">
                ...
                <div class="col-md-10">
                  <iframe class="vd" width="100%" height="450" src="https://www.youtube.com/embed/gWAVAllP4UM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
               </div>
               <div class="col-md-1"></div>
            ...
            <div class="row" style="display: flex;">
               ...
               <div class="col-md-8">
                 <p class="txt1">GBR Fertility Centre provides the best ethical IVF treatment at affordable cost with better transparency and patient confidentiality in chennai.</p>
                 <p class="txt1">In vitro fertilisation (IVF) is a form of assisted reproductive technology that involves a complex series of procedures used to help with fertility and assist with the conception of a child.</p>
                 ...
                 <ul class="wh">
                   ...
                   <h3 class="fs2">Benefits of IVF</h3>
                  <ul class="wh">                    
                    <li> IVF works where other infertility treatments fail.</li>
                    <li> You can have an edge over the timing.</li>
                    <li> Decrease your chances of miscarriage.</li>
                    <li> Increase your chances of conception.</li>
                    <li> Increase your chances of having a healthy baby.</li>                   
                 </ul>                     
               </div>
