      ...
      <?php include 'header.php'; ?>
         ...
         <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row">
               <div class="col-md-12">
                <h1 class="hed">Laser Assisted Hatching</h1>
               </div>
             </div>
            </div>
         </section>
...
<!--section open--->
          ...
          <div class="container">
            <div class="row" style="padding: 70px">
                ...
                <div class="col-md-10">
                  <iframe class="vd" width="100%" height="450" src="https://www.youtube.com/embed/LRwG9bIGeNs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>   
               </div>
               <div class="col-md-1"></div>
            ...
            <div class="row" style="display: flex;">
               ...
               <div class="col-md-8">
                 <p class="txt1">Laser-assisted hazard is an additional laboratory technique designed to improve the effectiveness of technological reproduction procedures such as IVF and ICSI.</p>
                 ...
                 <ul class="wh">
                   ...
                   <h3 class="fs">Benefits of Laser Assisted Hatching</h3>
                   <p class="txt1"> A laser has been shown to be superior to other forms of assisted hatching (chemical and manual) thanks to several advantages:</p>
                  <ul class="wh">                    
                    <li> Minimal handling of the embryo.</li>
                    <li> Fast and accurate control in shell opening.</li>
                    <li> Gentle and safe method, with no negative effects on the embryo.</li>
                    <li> It's hoped that it will improve the odds of implantation success and ultimately lead to a pregnancy.</li>                                    
                 </ul>                     
               </div>
