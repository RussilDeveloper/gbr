      ...
      <?php include 'header.php'; ?>
         ...
         <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row hd">
               <div class="col-md-12">
                <h1 class="hed">Tubal Recanalization</h1>
               </div>
             </div>
            </div>
         </section>
...
<!--section open--->
          ...
          <div class="container">
              <div class="row" style="padding-top: 50px; padding-bottom: 50px;">
                ...
                <div class="col-md-10">
                  <iframe class="vd" width="100%" height="450" src="https://www.youtube.com/embed/VoqwFrHbUnE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
               </div>
               <div class="col-md-1"></div>
            ...
            <div class="row" style="display: flex;">
               ...
               <div class="col-md-8">
                 <p class="txt1">Tubal recanalisation, or fallopian tube recanalization (FTR) is a nonsurgical procedure to clear blockages in the fallopian tubes of the reproductive system of women. This occurs usually as the result of debris that has built up in the tubes. Occasionally, scarring from surgery or serious infection can also lead to blockages.</p>
                 ...
                 <ul class="wh">
                   ...
                   <h3 class="fs">Benefits of FTR?</h3>
                   
                  <ul class="wh">                    
                    <li> Minimally invasive outpatient procedure with no incision needed.</li>
                    <li> There is an increased chance of pregnancy if this is the sole cause of infertility
                    .</li>
                    <li> Short procedure with no overnight stay.</li>
                    <li> Does not cause scarring or pain.</li>  
                    <li> Reduced risk of infection as compared to surgery.</li>                                    
                 </ul>                     
               </div>
