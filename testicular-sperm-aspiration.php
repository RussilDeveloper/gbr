      ...
      <?php include 'header.php'; ?>
          ...
          <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row hd">
               <div class="col-md-12">
                <h1 class="hed">Testicular Sperm Aspiration</h1>
               </div>
             </div>
            </div>
         </section>
        ...
        <section class="sec1">
          <div class="container">
            ...
            <div class="row" style="display: flex;">
               <div class="col-md-8">
                 <p class="txt1">Testicular Sperm Aspiration (TESA) is a procedure performed for men who are having their sperm retrieved for IVF or ICSI.</p>
                  ...
                  <ul class="wh">                    
                    <li> Pain and bleeding.</li>
                    <li> Infection.</li>
                    <li> Failure in finding sperm.</li>
                    <li> Need for future procedures.</li>
                    <li> Testicular injury or loss (although these are rare)</li>       
                  </ul>                     
               </div>
