      ...
      <?php include 'header.php'; ?>
         ...
         <section class="pd" style="background-color:#0e786b">
            <div class="container-fluid">
             <div class="row hd">
               <div class="col-md-12">
                <h1 class="hed">Sperm Freezing</h1>
               </div>
             </div>
            </div>
         </section>
...
<!--section open--->
          ...
          <div class="container">
             <div class="row" style="padding-top: 50px; padding-bottom: 50px;">
                ...
                <div class="col-md-10">
                  <iframe class="vd" width="100%" height="450" src="https://www.youtube.com/embed/et05BrR5upM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
               </div>
               <div class="col-md-1"></div>
            ...
            <div class="row" style="display: flex;">
               ...
               <div class="col-md-8">
                 <p class="txt1">Freezing sperm also known as cryopreservation or semen banking is a technique of preserving sperms by freezing using a special media and storing in liquid nitrogen at a temperature of - 196 C.T</p>
                 ...
                 <ul class="wh">
                   ...
                   <h3 class="fs">Benefits of Freezing Sperm</h3>
                   
                  <ul class="wh">                    
                    <li> Suitable for older men whose sperm count is low or sperm quality is deteriorating.
                    </li>
                    <li> Suitable for those involved in hazardous work or in high-risk professions such as the military, those undergoing medical procedures like vasectomy or gender reassignment surgery.</li>
                    <li> The best suited for Cancer patients waiting for chemotherapy or radiotherapy.</li>
